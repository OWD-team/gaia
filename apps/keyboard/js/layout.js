  ...
  fallbacks: {
    ...
    textType: {
      ...
      keys: [
        ...
        [{ value: '?123', keyCode: {changeto: 'symbols'}, ratio: 2}, { value: ';)', ratio: 1}, { value: ' ', ratio: 4, keyCode: KeyboardEvent.DOM_VK_SPACE, doubletap: [KeyEvent.DOM_VK_BACK_SPACE, '.'], repeat:true }, {value: '.', ratio: 1}, { value: '↵', ratio: 2, keyCode: KeyEvent.DOM_VK_RETURN }]
      ]
    }
    ...
    emailLayout: {
      ...
      keys: [
        ...
        'textType',
        'textType',
        [{ value: '123?', keyCode: {changeto: 'alternateLayout'}, ratio:2}, { value: '.', ratio: 1}, { value: ' ', ratio: 4, keyCode: KeyboardEvent.DOM_VK_SPACE, doubletap: [KeyEvent.DOM_VK_BACK_SPACE, '.'], repeat:true }, {value: ',', ratio: 1}, { value: '↵', ratio: 2, keyCode: KeyEvent.DOM_VK_RETURN }]
      ]
    }
